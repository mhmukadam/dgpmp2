...
dataset_folder   = os.path.abspath('../datasets/dataset_files/dataset_2d_9/')
plan_param_file  = os.path.abspath(dataset_folder + '/gpmp2_params.yaml')
robot_param_file = os.path.abspath(dataset_folder +'/robot.yaml')
env_param_file   = os.path.abspath(dataset_folder +'/env_params.yaml')
